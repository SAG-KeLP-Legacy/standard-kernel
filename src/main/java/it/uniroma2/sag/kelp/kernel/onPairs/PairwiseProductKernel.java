 ...
 * 
 * \(K( < x_1, x_2 >, < y_1,y_2 > ) = BK(x_1, y_1) \cdot BK(x_2, y_2) + BK(x_1, y_2) \cdot BK(x_2, y_1)\) <br>
 * 
 ...
 */
@JsonTypeName("pairwiseProduct")
public class PairwiseProductKernel extends KernelOnPairs{
	 ...
	 */
	public PairwiseProductKernel(Kernel baseKernel, boolean intraPairSimProduct){
		this.addIntraPairSimProduct = intraPairSimProduct;
		this.baseKernel=baseKernel;		
	}

	public PairwiseProductKernel(){
