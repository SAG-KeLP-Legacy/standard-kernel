 ...
 * 
 * \(K( < x_1, x_2 >, < y_1,y_2 > ) = BK(x_1, y_1) + BK(x_2, y_2)\) <br>
 * 
 * where BK is another kernel the kernel on pairs relies on. <br> 
 *
 * The uncrossed pairwise sum kernel is described in: 
 ...
 */
@JsonTypeName("uncrossedPairwiseSum")
public class UncrossedPairwiseSumKernel extends KernelOnPairs{
	 ...
	 */
	public UncrossedPairwiseSumKernel(Kernel baseKernel, boolean intraPairSimProduct){
		this.addIntraPairSimProduct = intraPairSimProduct;
		this.baseKernel=baseKernel;		
	}

	public UncrossedPairwiseSumKernel(){
